...
def Main_machine_learning(Nb_de_most_common_word):
        ...
        ##################################################################################################################
        chemin1 = os.getcwd() + '/base_apprentissage_sequences_format.txt'
        ...
        try:
                os.chdir(chemin3)
                model_format_json = model.to_json()
                with open("model_format.json", "w") as json_file:
                        json_file.write(model_format_json)
                        
                model.save_weights("model_format.h5")
